...
const AddNote = (props) => {
    ...
    const handleClick = (e) => {
        e.preventDefault();
        console.log("Adding Note: ", note); // Log the note object
    ...
    return (
        <div className="container my-3">
            ...
            <form className="my-3">
                ...
                <button disabled={note.title.length < 2 || note.description.length < 3} type="submit" className="btn btn-primary" onClick={handleClick}>Submit</button>
            </form>
        </div>
    )
}
